                ...
                <div class="card-body">
                     ...
                     if(isset($CEAction) && $CEAction == "new") {
                        ...
                        if(empty($question) or empty($answer)) {
                            ...
                            $query = $db->query("SELECT * FROM ce_faq WHERE question='$question'");
                            $row = $query->fetch_assoc();
                            // update operator activity start
							$activity_time = time();
							$activity_ip = $_SERVER['REMOTE_ADDR'];
							$update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','new_faq','$row[id]','$row[question]','$activity_ip','$activity_time')");
                ...
                <div class="card-body">
                     ...
                     if(isset($CEAction) && $CEAction == "save") {
                        ...
                        if(empty($question) or empty($answer)) {
							...
							$activity_time = time();
							$activity_ip = $_SERVER['REMOTE_ADDR'];
							$update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','edit_faq','$row[id]','$question','$activity_ip','$activity_time')");
							// update operator activity end
                        }
                     }
                     ?>
                ...
                <div class="card-body">
                     ...
                     if(isset($confirmed) && $confirmed == "1") {
                         // update operator activity start
							$activity_time = time();
							$activity_ip = $_SERVER['REMOTE_ADDR'];
							$update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','delete_faq','$row[id]','$row[question]','$activity_ip','$activity_time')");
							// update operator activity end
