...
if($op['can_manage_withdrawals'] !== "1") {
    header("Location: ./");
}
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <?php
                     ...
                     if(isset($confirmed) && $confirmed == "1") {
                        ...
                        $update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','approve_withdrawal','$row[id]','','$activity_ip','$activity_time')");
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <?php
                     ...
                     if(isset($confirmed) && $confirmed == "1") {
                        ...
                        $activity_time = time();
                        $activity_ip = $_SERVER['REMOTE_ADDR'];
                        $update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','cancel_withdrawal','$row[id]','','$activity_ip','$activity_time')");
                        // update operator activity end
