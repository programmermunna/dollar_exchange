            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="card-body">
                    ...
                    if(isset($CEAction) && $CEAction == "save") {
                        ...
                        $update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','update_directions','$row[id]','$row[name] $row[currency]','$activity_ip','$activity_time')");
