            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <?php
                     ...
                     if(isset($confirmed) && $confirmed == "1") {
                        ...
                        $update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','update_reserve','$row[gateway_id]','$row[amount]','$activity_ip','$activity_time')");
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <?php
                     ...
                     if(isset($confirmed) && $confirmed == "1") {
                        ...
                        $activity_time = time();
                        $activity_ip = $_SERVER['REMOTE_ADDR'];
                        $update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','delete_reserve','$row[gateway_id]','$row[amount]','$activity_ip','$activity_time')");
                        // update operator activity end
                     } else {
                        $gateway = gatewayinfo($row['gateway_id'],"name")." ".gatewayinfo($row['gateway_id'],"currency");
                        $currency = gatewayinfo($row['gateway_id'],"currency");
