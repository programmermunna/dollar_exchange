                ...
                <div class="card-body">
                     ...
                     if(isset($CEAction) && $CEAction == "new") {
                        ...
                        if(empty($title) or empty($content)) {
                            ...
                            $query = $db->query("SELECT * FROM ce_news WHERE title='$title' ORDER BY id DESC LIMIT 1");
                            $row = $query->fetch_assoc();
                            // update operator activity start
                        $activity_time = time();
                        $activity_ip = $_SERVER['REMOTE_ADDR'];
                        $update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','new_post','$row[id]','$row[title]','$activity_ip','$activity_time')");
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="card-body">
                     ...
                     if(isset($CEAction) && $CEAction == "save") {
                        ...
                        $activity_time = time();
                        $activity_ip = $_SERVER['REMOTE_ADDR'];
                        $update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','edit_post','$row[id]','$row[title]','$activity_ip','$activity_time')");
                        // update operator activity end
                        }
                     }
                     ?>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="card-body">
                     ...
                     if(isset($confirmed) && $confirmed == "1") {
                        ...
                        $activity_time = time();
                        $activity_ip = $_SERVER['REMOTE_ADDR'];
                        $update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','delete_post','$row[id]','$row[title]','$activity_ip','$activity_time')");
                        // update operator activity end
