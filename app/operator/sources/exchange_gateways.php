                ...
                <div class="card-body">
                     ...
                     if(isset($CEAction) && $CEAction == "new") {
                        ...
                        if(empty($name) or empty($currency) or empty($min_amount) or empty($max_amount) or empty($reserve)) {
							...
							$update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','add_gateway','$row[id]','$row[name] $row[currency]','$activity_ip','$activity_time')");
                ...
                <div class="card-body">
                     ...
                     if(isset($CEAction) && $CEAction == "save") {
                        ...
                        if(empty($min_amount) or empty($max_amount) or empty($reserve)) {
							...
							$activity_time = time();
							$activity_ip = $_SERVER['REMOTE_ADDR'];
							$update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','edit_gateway','$row[id]','$row[name] $row[currency]','$activity_ip','$activity_time')");
							// update operator activity end
						}
                     }
                     ?>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="card-body">
                     ...
                     if(isset($confirmed) && $confirmed == "1") {
							...
							$activity_time = time();
							$activity_ip = $_SERVER['REMOTE_ADDR'];
							$update = $db->query("INSERT ce_operators_activity (oid,activity_type,activity_id,activity_value,ip,created) VALUES ('$_SESSION[ce_operator_uid]','delete_gateway','$row[id]','$row[name] $row[currency]','$activity_ip','$activity_time')");
							// update operator activity end
